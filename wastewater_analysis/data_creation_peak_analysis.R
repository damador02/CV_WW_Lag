...
#Filtering data to only keep the same dates
plant1_cv = "Modesto"
plant2_ba = "Oceanside"
...
#removing false peaks -- when necessary
...
create_peak_date_table <- function(peak_table, plant1, plant2) {
  ...
  peaks_table <- gt(peaks_date) %>% #creating table
    ...
    tab_header(title = md("**Table 1c.** Dates for Identified Wave Peaks")) #creating table header
